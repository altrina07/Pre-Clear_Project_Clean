        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 rounded-xl border border-blue-200 p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div>
                <p className="text-blue-600">Booking Date</p>
                <p className="text-blue-900">{shipment?.paymentDate ? new Date(shipment.paymentDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : shipment?.bookingDate ? new Date(shipment.bookingDate).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : 'N/A'}</p>
              </div>
              <div>
